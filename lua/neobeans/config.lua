...
M.highlights_base = function (colors)
  return {
    ...
    FoldColumn = { bold = true, fg = colors.cursorline, bg = colors.background },
    ...
    iCursor = { bg = colors.cursor },
    lCursor = { bg = colors.cursor },
    CursorIM = { bg = colors.cursor },
    TermCursor = { bg = colors.cursor },
    TermCursorNC = { bg = colors.cursor },
    Conceal = { fg = colors.window, bg = colors.transparent },
    Directory = { fg = colors.foreground },
    SpecialKey = { fg = colors.sline },
    Title = { bold = true, fg = colors.foreground },
...
--[[ TODO: Currently not used
    ...
    DiffText = { bg = colors.blue_darker },

    -- Diffview File History
    DiffviewDiffDeleteDim = { fg = colors.line },
    ...
    NeogitHunkHeaderCursor = { bold = true, bg = colors.ruler, fg = colors.literal },
    NeogitHunkHeaderHighlight = { bold = true, bg = colors.ruler, fg = colors.literal },
    NeogitDiffContext = { bg = colors.ruler, fg = colors.foreground },
    NeogitDiffContextHighlight = { bg = colors.ruler, fg = colors.foreground },
    NeogitDiffDelete = { fg = colors.foreground, bg = colors.red_dark },
    NeogitDiffDeleteCursor = { fg = colors.foreground, bg = colors.red_dark },
    NeogitDiffDeleteHighlight = { fg = colors.foreground, bg = colors.red_dark },
    NeogitDiffAdd = { fg = colors.foreground, bg = colors.green_dark },
    NeogitDiffAddCursor = { fg = colors.foreground, bg = colors.green_dark },
    NeogitDiffAddHighlight = { fg = colors.foreground, bg = colors.green_dark },
    NeogitDiffContextCursor = { fg = colors.foreground },
    ...
    NeogitRemote = { bold = true, fg = colors.literal },
    ...
    NotifyTRACEBorder = { fg = colors.ruler },
    NotifyERRORIcon = { fg = colors.red_light },
    NotifyWARNIcon = { fg = colors.orange },
    NotifyINFOIcon = { fg = colors.green },
    NotifyDEBUGIcon = { fg = colors.comment },
    NotifyTRACEIcon = { fg = colors.ruler },
    NotifyERRORTitle = { fg = colors.red_light },
    NotifyWARNTitle = { fg = colors.orange },
    NotifyINFOTitle = { fg = colors.green },
    NotifyDEBUGTitle = { fg = colors.foreground },
    NotifyTRACETitle = { fg = colors.comment },

    -- Render Markdown
    MarkdownHeader = { bold = true },
    MarkdownCode = { bg = colors.ruler },
    RenderMarkdownCodeFallback = { bg = colors.ruler },
    markdownCodeDelimiter = { bg = colors.ruler },
    RenderMarkdownCode = { bg = colors.ruler },
    RenderMarkdownDash = { fg = colors.ruler },
    ...
    NvimTreeFileIcon = { fg = colors.comment },
